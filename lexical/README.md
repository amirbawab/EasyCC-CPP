...
<table>
  ...
  <tr>
    ...
    <td>Map values to their corresponding new token names. For example the value `if` can be mapped to `T_IF` in the scope of the token name `T_WORD`.</td>
    <td>
